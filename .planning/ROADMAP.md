...
- [x] 01-03-PLAN.md — Fullscreen shell, viewport, HUD, states, and gameplay CSS
- [x] 01-04-PLAN.md — Live race route integration and phase gate verification
...
Plans:
- [x] 02-01-PLAN.md — Phase 1 prerequisite gate and shared drag gear contracts
- [x] 02-02-PLAN.md — Deterministic drag gear scoring and acceleration rules
- [x] 02-03-PLAN.md — Server runtime adapter for `race:drag-sprint`
- [x] 02-04-PLAN.md — Drag HUD, RPM meter, straight track, and action controls
- [x] 02-05-PLAN.md — Fullscreen drag route and throttle/shift input lifecycle
- [x] 02-06-PLAN.md — Drag results summary and final verification gate
...
- [x] 03-06-PLAN.md — Dodge results summary and final verification gate
